<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-900 dark:text-gray-400">
      I'm Zayn, junior in Jilin University.
    </p>
    <p class="text-gray-900 dark:text-gray-400">
      I'm a Developer programming with web, scientific computing and deep learning✨.
    </p>
  </div>
</template>
...
useSeoMeta({
  title: "Zayn",
  description:
    "I'm Zayn, programming with web, scientific computing and deep learning.",
});
</script>
